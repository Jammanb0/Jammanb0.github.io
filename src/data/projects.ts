...
export const projects: Project[] = [
  {
    ...
    summary: '지도에서 프로젝트·스터디원을 매칭하고, 팀 협업(채팅·일정·랭킹)까지 한 곳에서 처리하는 플랫폼입니다.',
  ...
  },
  {
    ...
    summary: '브라우저 환경에서 실시간 코드 동시 편집, 채팅, 파일 업로드/다운로드를 지원하는 웹 IDE입니다.',
    role: 'Frontend Developer (7인 팀 · 구름 풀스택 부트캠프)',
    highlights: [
  ...
  },
  {
    ...
    summary: '공공데이터와 교내 태양광 발전량 데이터를 활용해 하이브리드 에너지 시스템을 관리·시각화하는 웹 서비스입니다.',
    role: '프로젝트 총괄 기획 · 프론트엔드 개발 (대학교 4학년 캡스톤 디자인)',
    highlights: [
